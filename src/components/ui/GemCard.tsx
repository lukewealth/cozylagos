...
import { Star, MapPin, Flame, ArrowUpRight, Play } from 'lucide-react';
...
export default function GemCard({ listing, onClick, index }: GemCardProps) {
  ...
  return (
    <>
        ...
        <div className="relative aspect-[4/3] overflow-hidden">
          ...
          {listing.videoUrl && (
            <button
              ...
              className="absolute top-2.5 right-12 bg-gold/90 backdrop-blur-md hover:bg-gold text-charcoal p-1.5 rounded-full shadow-lg transition-all opacity-0 group-hover:opacity-100"
      ...
      {showVideoPreview && listing.videoUrl && (
        <VideoPlayer
