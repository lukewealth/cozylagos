      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 bg-green-600 text-white font-bold text-[10px] sm:text-xs tracking-wider uppercase rounded-lg hover:bg-green-700 transition-all"
          >
